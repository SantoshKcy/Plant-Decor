    ...
    return (
        <div className={"py-container"}>
            ...
            <div className={"py-about-us-body"}>
                ...
                <h1>1. How can I make payments for my Plant Decor purchases?</h1>
                <p>Plant Decor provides you with convenient payment options. You can choose between online payment using Khalti wallet or opt for cash on delivery.</p>
